...
// role:width:direction:                              readdata:64:input
// 0
//-----------------------------------------------------------------------------
`timescale 1 ps / 1 ps
...
(
   ...
   //--------------------------------------------------------------------------
   input [63 : 0] sig_readdata;

   // synthesis translate_off
   import verbosity_pkg::*;
   
   typedef logic [63 : 0] ROLE_readdata_t;

   logic [63 : 0] sig_readdata_in;
   logic [63 : 0] sig_readdata_local;
