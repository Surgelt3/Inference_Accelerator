...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/TOP.v \
  $QSYS_SIMDIR/submodules/Addition32Bit.v \
  $QSYS_SIMDIR/submodules/CONTROL_UNIT.v \
  $QSYS_SIMDIR/submodules/CompareAndShift32Bit.v \
  $QSYS_SIMDIR/submodules/FIFO.v \
  $QSYS_SIMDIR/submodules/INSTR_DECODER.v \
  $QSYS_SIMDIR/submodules/INSTR_MEM.v \
  $QSYS_SIMDIR/submodules/Multiplication32bit.v \
  $QSYS_SIMDIR/submodules/NPU.v \
  $QSYS_SIMDIR/submodules/PE.v \
  $QSYS_SIMDIR/submodules/PE_SWITCH.v \
  $QSYS_SIMDIR/submodules/READ_BUFF.v \
  $QSYS_SIMDIR/submodules/RELU6.v \
  $QSYS_SIMDIR/submodules/WRITE_BUFF.v \
  $QSYS_SIMDIR/submodules/adder_32bit.v \
  $QSYS_SIMDIR/submodules/multiplier_32bit.v \
  $QSYS_SIMDIR/submodules/MEM_LOCAL.v \
  $QSYS_SIMDIR/submodules/Normalization32Bit.v \
